Блок это паттерн который был создан в Google, он позволяет отделить визуальное представление в приложении от бизнес логики. Акроним расшифровывается как - Business Logic Component.
